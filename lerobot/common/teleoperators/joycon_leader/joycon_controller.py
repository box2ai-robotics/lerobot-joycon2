...
class JoyConController:
    def __init__(
        ...
        **kwargs,
        ...
        self.name = name
        self.xml_path = "./lerobot/common/teleoperators/joycon_leader/scene_so101.xml"
        ...
        # self.glimit = [[0.11, -0.4,  -0.1, -3.1, -0.75, -1.5], 
        #             [0.320,  0.4,  0.23, 2.0,  1.57,  1.5]]
        self.glimit = [[0.11, -0.4,  -0.1, -3.1, -1.5, -1.5], 
                    [0.320,  0.4,  0.23, 2.0,  1.5,  1.5]]
        
        # self.init_qpos = np.array([0.0, -3.14, 3.14, 0.0, -1.57, -0.157])
        self.init_qpos = np.array([0.0, -1.4, 1.5, 0.0, 0.0, -0.157 ])
    ...
    def get_command(self, present_pose = None):
...
class JoyConController_plus:
    def __init__(
        ...
        **kwargs,
        ...
        self.name = name
        self.xml_path = "./lerobot/common/teleoperators/controllers/scene_plus.xml"
        self.mjmodel = mujoco.MjModel.from_xml_path(self.xml_path)
